...
def main():
    ...
    fileTrainLst ={'group1':'Group5H1_trainning_dataset_all.csv',
                   'group2':'Group5H2_trainning_dataset_all.csv', 
                   'group3':'Group5H3_trainning_dataset_all.csv',}
    ...
    ModelTrainSummary.to_csv('ModelTrainSummary_all.csv')
